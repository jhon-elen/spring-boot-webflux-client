package com.bolsadeideas.springboot.webflux.spring_boot_webflux_client.handler;

import com.bolsadeideas.springboot.webflux.spring_boot_webflux_client.models.Producto;
import com.bolsadeideas.springboot.webflux.spring_boot_webflux_client.models.services.ProductoService;
...
public class ProductoHandler {
    ...
    public Mono<ServerResponse> editar(ServerRequest request) {
        ...
        String id = request.pathVariable("id");
        return errorHandler(
            producto.flatMap(p -> service.update(p, id))
    ...
    public Mono<ServerResponse> upload(ServerRequest request) {
        String id = request.pathVariable("id");
        return errorHandler(
            request.multipartData().map(m -> m.toSingleValueMap().get("file"))
                .cast(FilePart.class)
